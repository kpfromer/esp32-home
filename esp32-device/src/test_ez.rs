...
async fn main(_spawner: Spawner) {
    ...
    let mut r_led = io.pins.gpio16.into_push_pull_output();
    let mut g_led = io.pins.gpio17.into_push_pull_output();
    let mut b_led = io.pins.gpio18.into_push_pull_output();
